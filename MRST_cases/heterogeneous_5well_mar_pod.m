...
dir='/home/wagm/cortes/Localdisk/Results/2017/11/tests/';
...
l =diag(A);
L = diag(l);
[x11,hc0,hc01,hc02]=ICCG_0(A,b,xi,maxits,tol,L,e); 
pause
%[result,flag,res,its,resvec] = diccg_s_A(A,b,Z,tol,maxit,L,L',x0);
A = sparse(A);
[result,flag,res,its,resvec] = iccg_s_A(A,b,tol,maxits,L,L',xi);
figure
[ht]=plotingsolution(G,W,'s', result,1) ;
...
close all
 ...
 solve_DICCG_f_pod(num,nn,e,maxits,dir,k1);

        ...
        for def=[0 1 ]
            ...
            for pod = [ 0 1]
                ...
                for rr=1:2
                    ...
                    dir='/mnt/sda2/cortes/Results/2017/Report/11_19/1/';
                   % dir='/dev/media/Sphinx/Doctorado_Delft/2017/08/Report/wtb/bc/';
                    ...
                    psolve = @(rSol,p0) ...
    incompTPFA_Def(rSol, G, hT, fluid, 'bc', bc,'LinSolve', fn,'x0',p0);
                  ...
                  %  rSol = psolve(rSol);
                    ...
                    psolve = @(rSol,p0) ...
    incompTPFA_Def(rSol, G, hT, fluid, 'bc', bc,'LinSolve', fn,'x0',p0);
                            [rSol,preport(ts)]    = psolve(rSol,p0);
                            ...
                            if ts <dv+1
                               ...
                               % return
                                ...
                                fn = @(A, b) solver.solveLinearSystem(A, b);
psolve = @(rSol,p0) ...
    incompTPFA_Def(rSol, G, hT, fluid,'LinSolve', fn,'bc', bc);
           [rSol,preport(ts)]    = psolve(rSol,p0);
